...
// ตรวจสอบสิทธิ์ (เฉพาะ admin และ pharmacist)
...
// ลบคิว
$result = $queue_manager->deleteQueue($queue_id);
...
if ($result) {
    ...
    echo json_encode(['success' => false, 'message' => 'Failed to delete queue']);
}
?>